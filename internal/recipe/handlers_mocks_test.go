...
//
//	mockgen -source=./internal/recipe/handlers.go -destination=./internal/recipe/handlers_mocks_test.go -mock_names=recipeService=MockRecipeService -package=recipe_test
//

// Package recipe_test is a generated GoMock package.
package recipe_test
